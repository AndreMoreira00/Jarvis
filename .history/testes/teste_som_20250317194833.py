...
class Control:  # Classe de Controle de funções
    def __init__(self):
        ...
        self.audio_start_sound = "audios_check"  # Som para início de captura de áudio
        self.photo_take_sound = "audios_check " # Som para tirar fotos
        self.video_start_sound = "audios_check "  # Som para início de gravação de vídeo
        self.video_end_sound = "audios_check/"  # Som para término de gravação de vídeo
        pygame.mixer.init()
